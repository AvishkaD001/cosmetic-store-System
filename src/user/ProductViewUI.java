 ...
 * @author avish
 */
public class ProductViewUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 390, 640, 320));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 360, -1, 20));
        ...
        getContentPane().add(srchName, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 360, 180, -1));
        ...
        getContentPane().add(srchIDbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 360, 150, -1));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 640, 350));

        setSize(new java.awt.Dimension(644, 750));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductViewUI().setVisible(true);
            }
        });
    }
